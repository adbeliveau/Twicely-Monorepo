...
// FLAG: ./doctor-checks and ./types are local siblings from apps/web/src/lib/monitoring/
// They were not part of the files to copy. These imports reference modules that have
// no @twicely/* package equivalent. They need to be copied or re-exported.
import { DOCTOR_CHECKS } from './doctor-checks';
import type { DoctorSummary, ServiceHealthStatus } from './doctor-types';
