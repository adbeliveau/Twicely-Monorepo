...
import { helpdeskCase, caseMessage, caseEvent, helpdeskMacro, caseCsat, sequenceCounter } from '../schema';
...
async function seedMessages(db: PostgresJsDatabase): Promise<void> {
...
async function seedEvents(db: PostgresJsDatabase): Promise<void> {
...
async function seedMacros(db: PostgresJsDatabase): Promise<void> {
...
async function seedCsat(db: PostgresJsDatabase): Promise<void> {
...
export const HELPDESK_CASE_IDS = CASE_IDS;
