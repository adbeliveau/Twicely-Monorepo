 ...
 * Normalizer functions in @twicely/crosslister poshmark-normalizer.ts.
 */
...
import type { PoshmarkListingsResponse } from '@twicely/crosslister/connectors/poshmark-types';
import {
  loadPoshmarkConfig,
  extractSessionData,
