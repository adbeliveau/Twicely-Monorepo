...
export const HUB_NAV: HubNavSection[] = [
  ...
  // ─── FINANCE (sub-group under Selling) ──────────────────────────
  {
    ...
    items: [
      ...
      { key: 'integrations', label: 'Integrations', href: '/my/selling/finances/integrations', icon: 'Link2',
        requiresScope: 'finances.view' },
      { key: 'reports', label: 'Reports', href: '/my/selling/finances/reports', icon: 'PieChart',
        requiresScope: 'finances.view' },
      { key: 'finance-settings', label: 'Settings', href: '/my/selling/finances/settings', icon: 'Settings',
        requiresScope: 'finances.view' },
    ],
  },
  ...
  // ─── SELLER EXTRAS (flat items after sub-groups) ────────────────
  {
    ...
    items: [
      ...
      { key: 'performance', label: 'Performance', href: '/my/selling/performance', icon: 'Activity',
        requiresScope: 'analytics.view' },
      { key: 'promoted', label: 'Promoted', href: '/my/selling/promoted', icon: 'Rocket',
        requiresScope: 'promotions.view' },
