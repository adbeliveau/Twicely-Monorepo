...
export const ADMIN_NAV_EXTENDED: AdminNavItem[] = [
  ...
  },
  {
    ...
    roles: ['ADMIN', 'DEVELOPER'],
    children: [
      { key: 'cfg-search-overview', label: 'Dashboard', href: '/cfg/search', icon: 'LayoutDashboard', roles: ['ADMIN', 'DEVELOPER'] },
      { key: 'cfg-search-settings', label: 'Settings', href: '/cfg/search/settings', icon: 'Sliders', roles: ['ADMIN'] },
      { key: 'cfg-search-relevance', label: 'Relevance', href: '/cfg/search/relevance', icon: 'BarChart', roles: ['ADMIN'] },
      { key: 'cfg-search-facets', label: 'Facets', href: '/cfg/search/facets', icon: 'ListFilter', roles: ['ADMIN'] },
      { key: 'cfg-search-synonyms', label: 'Synonyms', href: '/cfg/search/synonyms', icon: 'Replace', roles: ['ADMIN'] },
      { key: 'cfg-search-rules', label: 'Rules', href: '/cfg/search/rules', icon: 'Filter', roles: ['ADMIN'] },
      { key: 'cfg-search-indexes', label: 'Indexes', href: '/cfg/search/indexes', icon: 'Database', roles: ['ADMIN', 'DEVELOPER'] },
      { key: 'cfg-search-analytics', label: 'Analytics', href: '/cfg/search/analytics', icon: 'TrendingUp', roles: ['ADMIN'] },
      { key: 'cfg-search-health', label: 'Health', href: '/cfg/search/health', icon: 'Activity', roles: ['ADMIN', 'DEVELOPER'] },
    ],
  },
  {
    key: 'roles',
