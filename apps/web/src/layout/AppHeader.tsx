...
import StaffNotificationDropdown from "@/components/header/StaffNotificationDropdown";
...
const AppHeader: React.FC = () => {
  ...
  // Try to get staff context - will be undefined if not in staff context
  let staff = null;
  try {
    const staffAuth = useStaffAuth();
    staff = staffAuth.staff;
  } catch {
    // Not in StaffAuthProvider context - that's fine, use regular notifications
  }
      ...
      <div className="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 xl:justify-normal xl:border-b-0 xl:px-0 xl:py-4">
          ...
          <div className="hidden xl:block">
            <div className="relative">
              ...
              <button
                type="button"
                className="absolute right-2.5 top-1/2 inline-flex -translate-y-1/2 items-center gap-0.5 rounded-lg border border-gray-200 bg-gray-50 px-[7px] py-[4.5px] text-xs -tracking-[0.2px] text-gray-500 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800"
              >
                <span> ⌘ </span>
                <span> K </span>
              </button>
        ...
        >
          <div className="flex items-center gap-2 2xsm:gap-3">
            ...
            {/* Show staff notifications in corp area, regular notifications elsewhere */}
            {staff ? <StaffNotificationDropdown /> : <NotificationDropdown />}
