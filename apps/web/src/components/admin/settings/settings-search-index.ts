...
export const SEARCH_INDEX: SearchEntry[] = [
  ...
  entry('review.eligibleDaysAfterDelivery', 'Review Eligible Days', 'Days after delivery before review', 'Trust & Quality', `${P}trust`),
  entry('review.windowDays', 'Review Window', 'Days to leave review after eligible', 'Trust & Quality', `${P}trust`),
  ...
  entry('review.editWindowHours', 'Review Edit Window', 'Hours to edit review after posting', 'Trust & Quality', `${P}trust`),
  ...
  entry('gdpr.dataExportEnabled', 'Data Export', 'Allow users to export their data', 'Privacy', `${P}privacy`),
  entry('gdpr.deletionGracePeriodDays', 'Deletion Grace Period', 'Days before permanent deletion', 'Privacy', `${P}privacy`),
  entry('gdpr.anonymizeOnDeletion', 'Anonymize on Deletion', 'Anonymize vs hard delete', 'Privacy', `${P}privacy`),
  entry('gdpr.cookieConsentRequired', 'Cookie Consent', 'Require cookie consent banner', 'Privacy', `${P}privacy`),
