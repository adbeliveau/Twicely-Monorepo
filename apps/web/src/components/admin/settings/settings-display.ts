...
const L: Record<string, string> = {
  ...
  'privacy.gdpr.dataExportEnabled': 'Data Export (GDPR)',
  'privacy.gdpr.deletionGracePeriodDays': 'Deletion Grace Period',
  'privacy.gdpr.anonymizeOnDeletion': 'Anonymize on Deletion',
  'privacy.gdpr.cookieConsentRequired': 'Cookie Consent Required',
