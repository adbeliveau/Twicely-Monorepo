...
import { createAffiliatePromoCode } from '@/lib/actions/promo-codes-affiliate';
...
export function CreatePromoCodeDialog({
  ...
  void affiliateId; // reserved for future use
          ...
          <div className="space-y-2">
            ...
            >
              <div className="flex items-center gap-1.5">
                ...
                <Label htmlFor="type-pct">Percentage (BPS)</Label>
              </div>
              <div className="flex items-center gap-1.5">
                <RadioGroupItem value="FIXED" id="type-fixed" />
                <Label htmlFor="type-fixed">Fixed (cents)</Label>
              </div>
            </RadioGroup>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <Input
                ...
                placeholder={discountType === 'PERCENTAGE' ? '1000' : '500'}
                required
              />
            </div>
            <div className="space-y-1">
            ...
            <div className="grid grid-cols-2 gap-2">
              {SCOPE_OPTIONS.map((opt) => (
                <div key={opt.value} className="flex items-center gap-2">
                  ...
                  />
                  <Label htmlFor={`scope-${opt.value}`} className="cursor-pointer font-normal">
                    {opt.label}
                  </Label>
                </div>
              ))}
