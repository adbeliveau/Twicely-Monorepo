      ...
      <form onSubmit={handleSubmit} aria-describedby={error ? 'signup-error' : undefined} className="space-y-4">
        ...
        <div className="flex items-start">
          <input
            ...
            required
            className="mt-1 h-4 w-4 rounded border-gray-300 text-primary focus:ring-ring"
            disabled={isLoading}
          />
          <label htmlFor="terms" className="ml-2 text-sm text-gray-600">
            I agree to the{' '}
            <Link href="/p/terms" className="text-primary hover:underline">
              Terms of Service
            </Link>{' '}
            and{' '}
            <Link href="/p/privacy" className="text-primary hover:underline">
              Privacy Policy
            </Link>
          </label>
        </div>
